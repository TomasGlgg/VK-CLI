...
class Private_dialog(Dialog):
    __events_parser = ArgumentParser(prog='online', description='Вывод сообщений в реальном времени')
    __events_parser.add_argument('-t', '--typing', dest='typing', action='store_true',
